...
<html lang="de">
    ...
    <body>
        <div>
            ...
            <h4>Geburtsdatum: <span id="date-of-birth"></span></h4>
            <h4>Ihr Alter beträgt <span id="age" style="color: green"></span> Jahre.</h4>
            <h4>Volljährig: <span id="full-age"></span></h4>
            <form action="/delete-account" method="POST">
                <input id="delete-account-btn" type="submit" value="Konto und alle Daten löschen">
            </form>
        </div>
        <script>
